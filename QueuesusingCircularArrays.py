class CIRCULARARRAYQUEUE:
    ...
    This is a **CIRCULAR QUEUE** - imagine the array as a circle where after the last position, we wrap back to the first position. This prevents us from having to shift all elements when we remove/dequeue items from the front.
    """
    ...
    def __init__(self):
        ...
        self._data which is basically a list filled with None values, the array...
        self._size: How many actual elements are at a given timestamp, we will initialize it to zero.
        self._front: The index or the position where the first element is located. we initialize to zero too."""
        ...
        # Here we keep track of how many elements that are actually in the list. for this case the no. of cars that are actually parked.
        self._size = 0
    ...
    def __len__(self):
        """This is an invalid constructor method or rather a dunder method, just like the __init__.
        It returns the size of an attribute created in the primary constructor.
        In this case, it's the elements currently in the queue.This is like counting how many cars we have in our circular parking lot."""
        return self._size
    ...
    def first(self):
        ...
        if self.is_empty():
            raise EmptyException(
                'Queue is empty')  # Now this exception is raised is by calling the class Exception and passing the exception type/message.
        # The front element is at position self._front in our array
        return self._data[self._front]

    def dequeue(self):
        """This method will remove and return the first element of the queue, fulfilling our principle FIFO: which is First In, First Out, This is like the first person.
    ...
    def _resize(self, new_capacity):
        ...
        THE CURRENT SIZE OF THE QUEUE IS MULTIPLIED BY A FACTOR SPECIFIED BY THE USER, IN THIS CASE; new_capacity
